...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/coreutils-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/coreutils-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add coreutils gnu-coreutils
# for installing globally
pixi global install coreutils gnu-coreutils
```
...
It is possible to list all of the versions of `coreutils` available on your platform:
...
```
pixi search coreutils --channel conda-forge
```
